...
new2 = Label(root,font=("arial", 12, 'bold'), fg="red",wraplength=500,justify=LEFT)
...
new3 = Label(root,font=("arial", 12, 'bold'), fg="red",wraplength=500,justify=LEFT)
...
new4 = Label(root,font=("arial", 12, 'bold'), fg="red",wraplength=500,justify=LEFT)
...
desc1 =open_bbc_page["articles"][1]["description"]
print(desc1)
...
desc1 =open_bbc_page["articles"][4]["description"]
print(desc5)
